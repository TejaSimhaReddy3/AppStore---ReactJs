...
class AppStore extends Component {
  ...
  getActiveTabs = searchTabs => {
    const {activeTabId} = this.state
    const filteredApps = searchTabs.filter(
      eachSearchTabs => eachSearchTabs.category === activeTabId,
    )
  ...
  getSearchOutputs = () => {
    ...
    const searchApps = appsList.filter(eachApp =>
  ...
  render() {
    ...
    const searchresults = this.getSearchOutputs()
      ...
      <div className="bg-container">
        <div className="content-container">
          ...
          <ul className="tab-names">
            {tabsList.map(eachTabName => (
              <TabItem
                key={eachTabName.tabId}
                tabDetails={eachTabName}
                setActiveTabId={this.setActiveTabId}
                isActive={activeTabId === eachTabName.tabId}
              />
            ))}
          </ul>
